export default function About() {
    ...
    const data = [
        ...
        },
        {
            ...
            description: 'Informatics and computer engineering at VNUIS',
        },
        {
            name: 'Experience',
            icon1: './assets/project-icon.png',
            icon2: './assets/project-icon-dark.png',
            description: 'English teacher for IELTS center',
        },
    ];
    return (
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I am originally from Nigeria, currently studying overseas in Vietnam. I'm in my 3rd year at the International school - Vietnam National University (VNUIS) majoring in Informatics and computer engineering. Alongside my studies, I am working as an English teacher at an IELTS center.</p>
